...
<html lang="en">
   <head>
      ...
      <link rel="icon" type="image/png" sizes="16x16" href="{!!asset('public/web_public/assets/assets/images/logoicon.png')!!}">
      <!-- Favicon icon -->
      <title>Afdal Analytics</title> 
      <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" />
      
      <link rel="stylesheet" href="{!!asset('public/web_public/assets/assets/node_modules/dropify/dist/css/dropify.min.css')!!}">
      <link rel="stylesheet" type="text/css"
        href="{!!asset('public/web_public/assets/assets/node_modules/datatables.net-bs4/css/dataTables.bootstrap4.css')!!}">
      <link rel="stylesheet" type="text/css"
        href="{!!asset('public/web_public/assets/assets/node_modules/datatables.net-bs4/css/responsive.dataTables.min.css')!!}">
        <link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
        <!--Toaster Popup message CSS -->
    <link href="{!!asset('public/web_public/assets/assets/node_modules/toast-master/css/jquery.toast.css')!!}" rel="stylesheet">
    
      <link href="{!!asset('public/web_public/assets/dist/css/style.min.css')!!}" rel="stylesheet">
      <link href="{!!asset('public/web_public/assets/dist/css/pages/float-chart.css')!!}" rel="stylesheet">
      <link rel="stylesheet" type="text/css" href="//cdn.jsdelivr.net/bootstrap.daterangepicker/2/daterangepicker.css" />
      <link href="{!!asset('public/web_public/assets/assets/node_modules/switchery/dist/switchery.min.css')!!}" rel="stylesheet" />

      
      <link href="{!!asset('public/web_public/assets/dist/css/new.css')!!}" rel="stylesheet">
      <style type="text/css">
         .bg-theme-bg{
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
               <div class="navbar-header">
                  <a class="navbar-brand" href="javascript:void(0)">
                     ...
                     <b>
                        ...
                        <!-- Dark Logo icon -->
                        <img src="{!!asset('public/web_public/assets/assets/images/users/1.jpg')!!}" height="40" alt="user-img" class="img-circle dark-logo" />
                        <!-- Light Logo icon -->
                        <img src="{!!asset('public/web_public/assets/assets/images/users/1.jpg')!!}" height="40" alt="user-img" class="img-circle light-logo" />
                     </b>
                     <!--End Logo icon -->
                     <!-- Logo text -->
                     <span>
               ...
               <div class="navbar-collapse">
                  ...
                  <li class="nav-item dropdown u-pro">
                     <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <span class="hidden-md-down mr-2 f-10-logo">Afdal Analytics</span> <img src="{!!asset('public/web_public/assets/assets/images/logoicon.png')!!}" alt="user" class=""> &nbsp;<i class="fa fa-angle-down"></i></a>
...
<script src="{!!asset('public/web_public/assets/assets/node_modules/jquery/jquery-3.2.1.min.js')!!}"></script>
<!-- Bootstrap tether Core JavaScript -->
<script src="{!!asset('public/web_public/assets/assets/node_modules/popper/popper.min.js')!!}"></script>
<script src="{!!asset('public/web_public/assets/assets/node_modules/bootstrap/dist/js/bootstrap.min.js')!!}"></script>
<!-- slimscrollbar scrollbar JavaScript -->
<script src="{!!asset('public/web_public/assets/dist/js/perfect-scrollbar.jquery.min.js')!!}"></script>
<!--Wave Effects -->
<script src="{!!asset('public/web_public/assets/dist/js/waves.js')!!}"></script>
<!--Menu sidebar -->
<script src="{!!asset('public/web_public/assets/dist/js/sidebarmenu.js')!!}"></script>
<!--stickey kit -->
<script src="{!!asset('public/web_public/assets/assets/node_modules/sticky-kit-master/dist/sticky-kit.min.js')!!}"></script>
<script src="{!!asset('public/web_public/assets/assets/node_modules/sparkline/jquery.sparkline.min.js')!!}"></script>
<!--Custom JavaScript -->
<script src="{!!asset('public/web_public/assets/dist/js/custom.min.js')!!}"></script>
<!-- Flot Charts JavaScript -->
<script src="{!!asset('public/web_public/assets/assets/node_modules/sparkline/jquery.charts-sparkline.js')!!}"></script>
<!-- Include Date Range Picker -->
<script type="text/javascript" src="//cdn.jsdelivr.net/momentjs/latest/moment.min.js"></script>
<script type="text/javascript" src="//cdn.jsdelivr.net/bootstrap.daterangepicker/2/daterangepicker.js"></script>
<script src="https://cdn.ckeditor.com/4.16.2/standard/ckeditor.js"></script>
<!-- This is data table -->
    <script src="{!!asset('public/web_public/assets/assets/node_modules/datatables.net/js/jquery.dataTables.min.js')!!}"></script>
    <script src="{!!asset('public/web_public/assets/assets/node_modules/datatables.net-bs4/js/dataTables.responsive.min.js')!!}"></script>
<!-- jQuery file upload -->
<script src="{!!asset('public/web_public/assets/assets/node_modules/dropify/dist/js/dropify.min.js')!!}"></script>
<script src="{!!asset('public/web_public/assets/assets/node_modules/switchery/dist/switchery.min.js')!!}"></script>
<!-- Popup message jquery -->
    <script src="{!!asset('public/web_public/assets/assets/node_modules/toast-master/js/jquery.toast.js')!!}"></script>
